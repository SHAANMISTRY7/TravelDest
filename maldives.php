...
<head>
    ...
    <title>TravelDest | Maldives</title>
</head>
<body>
    <div class="navbar">
    ...
    <section class="jumbotrone">
        <p style="font-style: normal;">Destinations in Maldives</p>
    </section>
    ...
    <section class="destinations container">
        <div class="countries">
            <?php
                ...
                $viewQuery = $con -> query("select * from destinations where country = 'Maldives'");
